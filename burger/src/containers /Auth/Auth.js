        ...
        return (
            <div className = {classes.Auth}>
                ...
                <form onSubmit={this.submitHandler}>
                    {form}
                    <Button buttonType="Success" > Sumbit </Button>
                </form>
                <Button clicked={this.switchtAuthModeHandler} buttonType="Danger" > {this.state.isSignUp ? 'Sign In' : 'Sign Up'}  </Button>
            </div>
        ); 
    }
}
